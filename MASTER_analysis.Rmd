...
head(df[, c(15:203)]) # remove extra from the front of the dataset from qualtrics
names(df)
```
# Read in codebook
```{r}
...
# Parenting practice constructs
These are based on the supplemental tables from the JAND manuscript
https://docs.google.com/document/d/1ounsp0ThSnj7UMhk9ZRTXFpLJQA8_gnu/edit?usp=share_link&ouid=109286687682807041919&rtpof=true&sd=true
...
summary(as.factor(df11$FOOD_SEC_CAT))
...
```{r}
#load(file = "/Users/gracer/OneDrive - University of Wyoming/0. Lab/M2AENAD Lab - Documents/RESEARCH/multi-state/master_data/2. data/master_3723.RData")
```
...
"SSB_iEO_freq"                 
[409] "SUGAR_iEO_freq"                "FAST_iEO_freq"                 "JUNK_iEO_freq"                 "FV_iEO_freq"                  
[413] "SSB_freq"                      "SUGAR_freq"                    "FAST_freq"                     "JUNK_freq"                    
[417] "FV_freq"                       "AUTONOMY"                      "MONITORING"                    "AVAILABILITY"                 
[421] "INDULGENCE"                    "MODELING"                      "EXPECTATIONS"                  "AUTONOMY_child"               
[425] "MONITORING_child"              "AVAILABILITY_child"            "INDULGENCE_child"              "MODELING_child"               
[429] "EXPECATIONS_child"             "parent_gender"                 "parent_ED"                     "INCOME"                       
[433] "selfreport_race"               "selfreport_ethnicity"          "parentreport_race_child"       "parentreport_ethnicitiy_child"
[437] "child_AGE"                     "child_SEX"                     "FOOD_SEC"                      "FOOD_SEC_CAT" 
# Getting variables for the gender analysis
```{r}
#df15<-vroom("/Users/gracer/OneDrive - University of Wyoming/0. Lab/M2AENAD Lab - Documents/RESEARCH/multi-state/master_data/2. data/master_df.csv")
names(df15)
colnames(df15[408:440])
colnames(df15[7])
colnames(df15[36])
colnames(df15[16])

interest<-c(colnames(df15[16]), colnames(df15[36]), colnames(df15[408:440]),colnames(df15[7]))
interest
gender_df<-df15[interest]
head(gender_df)

#write.table(gender_df, "/Users/gracer/OneDrive - University of Wyoming/0. Lab/M2AENAD Lab - Documents/RESEARCH/multi-state/gender_paper/2. data/fromMaster.csv", row.names = F, sep = ",")
```
